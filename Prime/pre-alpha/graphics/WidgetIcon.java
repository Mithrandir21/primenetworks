 ...
 * {@link objects.Object Object} within the system.
 * 
...
public class WidgetIcon extends JLabel
{
	 ...
	 * 
	 * The constructor also adds a mouseListener and sets a transferhandler for
	 * the JLabel icon.
	 * 
	 * @param icon
	 ...
	 * JLabel icon a name and sets a description of the object representer.
	 * 
	 * The constructor also adds a mouseListener and sets a transferhandler for
	 * the JLabel icon.
	 * 
	...
	/**
	 * This is the classes mouseListener. It gets the source of the mouse event,
	 * gets the transferhandler for the source and sets the action for the
	 * handler to exportAsDrag.
	 * 
