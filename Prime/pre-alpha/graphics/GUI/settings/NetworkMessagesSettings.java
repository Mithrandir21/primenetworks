		...
		layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup().addContainerGap().addGroup(
						layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(hardPanel,
								...
								Short.MAX_VALUE).addComponent(softPanel, GroupLayout.Alignment.TRAILING,
								GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE).addComponent(conPanel, GroupLayout.Alignment.TRAILING,
								GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE).addComponent(netPanel, GroupLayout.DEFAULT_SIZE,
		...
		jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(
						jPanel3Layout.createSequentialGroup().addGap(15, 15, 15).addComponent(showErroes).addGap(18, 18, 18)
								.addComponent(box1).addGap(74, 74, 74).addComponent(showWarnings).addGap(5, 5, 5)
								.addComponent(box2).addGap(74, 74, 74).addComponent(showNotices).addGap(5, 5, 5)
								.addComponent(box3).addContainerGap(79, Short.MAX_VALUE)));
				...
				.addGroup(
						jPanel3Layout.createSequentialGroup().addContainerGap().addGroup(
								jPanel3Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
										.addComponent(showErroes).addComponent(box1).addComponent(showWarnings)
										.addComponent(box2).addComponent(showNotices).addComponent(box3))
