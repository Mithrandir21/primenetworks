...
public class MakeStandardInternalComponents
{
	...
	/**
	 * Creates and returns what the system will regard as the standard Motherboard.
	 * It is this motherboard that will be the base for all the newly created
	 * computers in the system. It is given a certain set of ports and sockets.
	 * 
	...
	/**
	 * Creates and returns what the system will regard as the standard Motherboard for hardware
	 * that require a motherboard but do not require all the ports and sockets that a normal
	 * motherboard would provide, such as infrastructure or peripherals.
	 * 
	 * @return A new motherboard
	 */
	...
	/**
	 * Creates and returns what the system will regard as the standard external NIC.
	 * This nic will also contain a mac address. This mac address will mostly contain
	 * "0", but the last digits will be the number of components on the canvas.
	 * This is done so that each individual nic can have a different mac address. 
	 * 
	...
	/**
	 * Creates and returns what the system will regard as the standard internal NIC.
	 * This nic will also contain a mac address. This mac address will mostly contain
	 * "0", but the last digits will be the number of components on the canvas.
	 * This is done so that each individual nic can have a different mac address.
	 * 
