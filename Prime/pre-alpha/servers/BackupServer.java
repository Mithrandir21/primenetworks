...
/**
 * A representation of a backup server. This server will backup 
 * different information from one or multiple parts of the network.
 * <b>The functionality of the device is yet to be implemented.</b>
 *
...
public class BackupServer extends Servers implements Serializable 
{
	...
	// Connection to the exact Backup software that is going to be run on this server
