...
/**
 * A representation of a firewall server. This firewall, usually 
 * standing between the internet and the internal network, will 
 * accept, deny or proxy(if function available) connections to the
 * rest of the network.
 *
...
public class FirewallServer extends Servers implements Serializable 
{
	...
	// Connection to the exact firewall software that is going to be run on this server
	 ...
	 * @param FirewallSWname The name of the application that the server
	 * is set to run.
	 * @param FirewallSWdesc The description of the application that the
	 * server is set to run.
	 * @param FirewallSWversion The version of the application that the 
	 * server is set to run.
	 */
