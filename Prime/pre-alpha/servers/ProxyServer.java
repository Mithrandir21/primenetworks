...
/**
 * A representation of a proxy server. This server serves the rest
 * of network with information depending on the layout of the 
 * network itself and the purpose giving to the device by the network
 * administrator.
 *
...
public class ProxyServer extends Servers implements Serializable 
{
	...
	// Connection to the exact Proxy software that is going to be run on this server
	private Proxy Proxy;
	 ...
	 * @param ProxySWname The name of the application that the server
	 * is set to run.
	 * @param ProxySWdesc The description of the application that the
	 * server is set to run.
	 * @param ProxySWversion The version of the application that the 
	 * server is set to run.
	 */
