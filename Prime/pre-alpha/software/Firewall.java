...
/**
 * A class representing a software firewall.
 * This software is meant to run on a spesific machine with the goal of separating 
 * different networks which are at different trust leves. Its goal is to allow, deny or
 * proxy any connection from one network to another according to the rules that are 
 * given to it by the administrator.
 *
...
public class Firewall extends Software implements Serializable 
{
	...
	// NOTES - Connections to the different networks will be handled by the main system.
	...
	/**
	 * Get a boolean telling whether or not the firewall has
	 * a integrated antivirus.
	 *
	 */
	...
	/**
	 * Get a boolean that says if the firewall has an 
	 * application level firewall feature.
	 *
	 */
	...
	/**
	 * Get a boolean that says if the firewall has a deep package
	 * inspection firewall feature.
	 *
	 ...
	 * Description NEEDED!
	 *
	 * @param hasAntivirus the hasAntivirus to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param hasApplicationFirewall the hasApplicationFirewall to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param hasDPI the hasDPI to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param hasNAT the hasNAT to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param hasNetworkFirewall the hasNetworkFirewall to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param hasStatefulFirewall the hasStatefulFirewall to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param hasVPN the hasVPN to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param supportsDMZ the supportsDMZ to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param supportsForwarding the supportsForwarding to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param supportsPortForwarding the supportsPortForwarding to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param supportsQos the supportsQos to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param supportsRWA the supportsRWA to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param supportsTarpit the supportsTarpit to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param supportsToD the supportsToD to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param supportsTTL the supportsTTL to set
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param supportsModularity the supportsModularity to set
	 */
