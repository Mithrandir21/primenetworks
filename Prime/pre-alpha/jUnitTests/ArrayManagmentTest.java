...
public class ArrayManagmentTest extends TestCase
{
	...
	/**
	 * This testes the addItem function that should add a String to an
	 * array of Strings. The function checks whether or not the String
	...
	/**
	 * This testes the function to remove a String from an array of Strings.
	 * The function also removes null pointers from the array so that there
	 * are no null pointers left after the String removal. 
	 */
	@Test
	...
	/**
	 * This testes the function that changes one String at and index in
	 * an array with another.  
	 */
	@Test
