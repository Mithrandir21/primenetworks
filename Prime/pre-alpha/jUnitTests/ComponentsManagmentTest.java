...
public class ComponentsManagmentTest extends TestCase
{
	...
	/**
	 * Test to see whether or not several objects can be added to
	 * an object array or not. Also it checks if the object is the same
	 * before and after it is added to see if there are any changes 
	 * made to the object while adding it to the array.
	 */
	@Test
	...
	/**
	 * Test to see whether or not an object can be removed from 
	...
	public void testGetSpesificComponents() 
	{
		...
		try {
			found = ComponentsManagment.getSpesificComponents(Desktop.class, components, components.length);
