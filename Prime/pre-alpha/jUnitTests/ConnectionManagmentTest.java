...
public class ConnectionManagmentTest extends TestCase
{
	...
	public void testMakeConnection()
	{
		...
		try
		{
			con1 = ConnectionManagment.makeConnection(connections, "ConName", "ConDesc",
					newComponent1, newComponent2, "RJ-45", NetworkConnection.class);
		}
		...
		{
			JOptionPane.showMessageDialog(null,
					"JUnitTest - A connection between these two objects is not possible.", "alert",
		...
		try
		{
			con2 = ConnectionManagment.makeConnection(connections, "ConName", "ConDesc",
					newComponent1, newComponent2, "AGP", InternalConnection.class);
		}
		catch ( ConnectionDoesExist e )
		{
			JOptionPane.showMessageDialog(null,
		...
		try
		{
			con3 = ConnectionManagment.makeConnection(connections, "ConName", "ConDesc",
					newComponent1, newComponent2, "RJ-45", NetworkConnection.class);
		}
		catch ( ConnectionDoesExist e )
		{
	...
	public void testBreakConnection()
	{
		...
		try
		{
			con = ConnectionManagment.makeConnection(connections, "ConName", "ConDesc",
					newComponent1, newComponent2, "RJ-45", NetworkConnection.class);
		}
		catch ( ConnectionDoesExist e )
		{
		...
		try
		{
			connections = ConnectionManagment.breakConnection(connections, newComponent1,
					newComponent2);
		}
	...
	public void testChangeConnection()
	{
		...
		try
		{
			ConnectionManagment.changeConnection(connections, newComponent1, newComponent2,
					newComponent3);
		}
		catch ( ConnectionDoesNotExist e )
		{
