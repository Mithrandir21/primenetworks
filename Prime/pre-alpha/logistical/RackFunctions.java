...
/**
 * Functions class that contains functions to manage and manipulate the content of a rack.
 * Functions like calculating shelf space.
 *
...
public class RackFunctions
{
	...
	/**
	 * Calculates the number of shelfs needed to contain all the units 
	 * in the given array of units.
	 * 
