 ...
 * It is an exception made to handle situations that occur when a object class, 
 * such as a {@link  hardware.CPU  CPU} or {@link  hardware.HDD  motherboard}, is 
...
public class ObjectNotFoundException extends Exception
{
    ...
    /**
     * Constructs a new exception with the specified detail message, along with the class of
     * object that is not found. It stores the class of the object that was not found, which can be
     * accessed by the {@link  #getObjectClass()  getObjectClass()} function. 
     *
