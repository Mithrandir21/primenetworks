 ...
 * system. This is a dragable object that can be dropped within the {@link graphics.GUI.workareaCanvas.WorkareaCanvas
 * Canvas}.
 * 
...
public class WidgetIcon extends JLabel
{
	...
	/**
	 * This is the classes mouseListener. It gets the source of the mouse event, gets the transferhandler for the source
	 * and sets the action for the handler to exportAsDrag. Contains only a "mousePressed" method.
	 */
