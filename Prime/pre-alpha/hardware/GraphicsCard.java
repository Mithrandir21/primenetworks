...
/**
 * This class represents a graphical card within a {@link  objects.Servers  server} or 
 * {@link  objects.Clients  client} machine. 
 * It can be a server, a desktop or a laptop. It contains information on what kind 
 * of capability the graphical card has and what kind of system it can fit into.
 * <br><br>
 * <b>Notation</b>: The graphical card will be refered to as "GC" in the remainder of this document.
 * 
...
public class GraphicsCard extends Hardware implements Serializable 
{
	 ...
	 * @param Desc The description of the GC.
	 * @param GCtype The type of GC. AGP,PCI, PCI-Express and so on.
	 * @param GCram The size of GC ram in MB.
	 * @param GCoutputInterface The type of output of a GC. VGA, DVI and so on.
	 * @param GCisIntegrated Whether or not the GC is integrated on the MB.
	 */
	public GraphicsCard(String Name, String Desc, String GCtype,int GCram,String GCoutputInterface, boolean GCisIntegrated)
	{
		super(Name,Desc);
