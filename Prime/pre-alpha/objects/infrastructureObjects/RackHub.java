...
/**
 * A representation of a hub that fits into a {@link objects.infrastructureObjects.Rack 
 * 19"-rack}. This class will represent the exact same information that the
 * {@link objects.infrastructureObjects.Hub Hub} class represents, but with some additional
