...
/**
 * A representation of a Switch that fits into a {@link objects.infrastructureObjects.Rack 
 * 19"-rack}. This class will represent the exact same information that the
 * {@link objects.infrastructureObjects.Switch Switch} class represents, but with some
