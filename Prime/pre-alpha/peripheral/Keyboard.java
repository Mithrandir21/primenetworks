 ...
 * It contains information on what kind of capability the keyboard has and what 
...
public class Keyboard extends ExternalHardware implements Serializable 
{
	 ...
	 * @param Desc The description of the keyboard.
	 * @param KeyboardConnectionInterface The connection interface supported by a keyboard.
	 */
