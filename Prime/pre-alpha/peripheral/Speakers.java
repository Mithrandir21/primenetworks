...
/**
 * This class represents computer speakers.
 * This device can be connected to any device that supports the conncetion type of this device. 
 * It contains information on what kind of capability the speakers have and what 
 * kind of connection interface they have.
 *
...
public class Speakers extends ExternalHardware implements Serializable 
{
	 ...
	 *
	 * @param Name The name of the speakers.
	 * @param Desc The description of the speakers.
	 * @param Speakerssatellites The number of satellites, actual speakers.
	 */
