 ...
 * It contains information on what kind of capability the mouse has and what 
...
public class Mouse extends ExternalHardware implements Serializable 
{
	 ...
	 * @param Desc The description of the mouse.
	 * @param MouseConnectionInterface The connection interface supported by a mouse.
	 */
