 ...
 * It contains information on what kind of capability the printer machine has and what 
...
public class Scanner extends ExternalHardware implements Serializable 
{
	 ...
	 * @param Desc The description of the scanner.
	 * @param Sresolution Maximum resolution of a scanner.
	 * <br>This can be a NULL pointer. The value will then be a NULL pointer. 
	 * @param SconnectionInterfaces Connection interfaces supported by the scanner. An array of Strings.
	 */
