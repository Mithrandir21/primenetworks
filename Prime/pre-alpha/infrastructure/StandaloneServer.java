...
public class StandaloneServer extends Object implements Serializable
{
	...
	// An array of the objects it is connected to, whether by USB, RJ-45, bluetooth and so on.
	...
	// Nodes before it reaches the first router outside of the systems own routers, ie the Internet.
	...
	// The server objects the machine will be connected to
	private Servers[] ServerApplications;
	 ...
	 * This constructor also sets the number of components in the system
	 * and the server rating to "0"(since the rating system is not yet implemented).
	 *
	 * @param Name The name of the server. 
	 * @param Desc The description of the server.
	 * @param ServerComponents The initial components an instance of a server has.
	 */
	public StandaloneServer(String Name, String Desc, String[] SupConInt, Object[] ServerComponents, Servers[] app)
	{
	 ...
	 * 
	 * @return Returns an array of {@link  objects.Object  Objects} containing the components
	 ...
	 * 
	 * @param NewComponents Array of new components the server will contain.
	 */
	 ...
	 * 
	 * @param NewConnectedDevices Array of new connceted devices the server is connected to.
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param serverApplications the serverApplication to set
	 */
	public void setServerApplication(Servers[] serverApplications)
	{
	...
	{
		components = ComponentsManagment.removeComponents(
				ToBeRemoved, components, componentCounter);
	...
	{
		components = ComponentsManagment.addComponents(
				NewComponents, components, componentCounter);
	 ...
	 * 
	 * @param ToBeRemoved Connected device to be removed.
	 */
