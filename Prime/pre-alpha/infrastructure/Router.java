...
/**
 * A representation of a networking device called a router. This device is 
 * capable of highly planned and predictable path finding through different
 * networks. Routers are used, among other things, to connect different parts 
 * of an organization, businesses or even governments. Its the essential backbone
 * of the internet.
 * The devices main purpose is to interconnect separate 
 * logical subnets, and to keep track of the locations of many different 
 * resources to better be able to direct network traffic with the least amount
 * of collisions at the highest speed possible.
 *
