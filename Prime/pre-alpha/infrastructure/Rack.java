...
/**
 * This class represents a 19-inch rack.
 * This rack is basicly a container for different units, like switches and routers.
 * It contains information abour how many different units it can contain, depending on the
 * unit sizes.
 *
...
public class Rack extends Infrastructure implements Serializable 
{
	...
	/**
	 * Constructor for a rack class.
	 * This also creates an array that contains a given number of object 
	 * entires to contain the different units placed within the rack.
	 * It also sets the number of currently contained units and the
	 * number of currently occupied shelfs to 0.
	 * 
	 * @param Name The name of the rack.
	 * @param Desc The description of the rack.
	 * @param rackShelfs The number of shelfs, "U", on a rack.
	 */
	 ...
	 *
	 * @param numberOfShelfs The number of shelfs the rack can hold.
	 */
	 ...
	 *
	 * @param units The units that will replace the previous units.
	 */
	 ...
	 *  
	 * @param NewUnits An array of new units.
	 */
	public boolean addUnits(Object[] NewUnits) throws Exception
	{
		/*
		 *  If the number of shelfs needed by the new units is not bigger then the
		 *  number of shelfs available, the units will be installed. 
		*/
		if(!(RackFunctions.calculateShelfSpace(NewUnits)>(numberOfShelfs-occupiedShelfs)))
		{
			units = ComponentsManagment.addComponents(NewUnits
					, units, unitsCounter);
	 ...
	 * 
	 * @param NewUnit The unit to replace the previous one.
	...
	public boolean changeUnit(Object NewUnit, Object OldUnit)
	{
		...
		*/
		...
		{
			units = ComponentsManagment.changeComponent(NewUnit
					,OldUnit, units, unitsCounter);
	 ...
	 * 
	 * @param ToBeRemoved Units to be removed.
	 */
	public void removeComponent(Object[] ToBeRemoved) throws ObjectNotFoundInArrayException
	{
		units = ComponentsManagment.removeComponents(
				ToBeRemoved, units, unitsCounter);
