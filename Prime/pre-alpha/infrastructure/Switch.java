...
/**
 * A representation of a networking device called a switch.
 * This device is slightly more complex then a hub, but not nearly as
 * complex as a router. This device does almost the same as a hub does, but
 * it also can identify where communications should be forwarded 
 * because of previous activities to and from a port. 
 * It will connected a certain port to the client that sends 
 * information from that port, and forward any communications 
 * to that client directly to the port that client uses to send 
 * communications from. This makes for much better flow of 
 * communications, and somewhat better handling of connections 
 * between networks.
 *
...
public class Switch extends Infrastructure implements Serializable
{
	 ...
	 * @param outPorts The number of ports that can be connected to different 
	 * computers or subnets.
	 * @param inPorts The number of ports that are meant to be used providers of
	 * internet access.
	 ...
	 *
	 * @param conncetionInterfaces the conncetionInterfaces to set
	 */
	 ...
	 *
	 * @param supportedDuplexType the supportedDuplexType to set
	 */
	 ...
	 *
	 * @param supportedLinkProtocols the supportedLinkProtocols to set
	 */
	 ...
	 *
	 * @param supportedRemoteManageProtocols the supportedRemoteManageProtocols to set
	 */
	 ...
	 *
	 * @param supportedTransportProtocols the supportedTransportProtocols to set
	 */
	 ...
	 *
	 * @param supportsWired A boolean on whether or not the device supports wired connections.
	 */
	 ...
	 *
	 * @param supportsWireless A boolean on whether or not the device supports wireless connections.
	 */
	 ...
	 *
	 * @param switchPorts The number of different network ports the device has.
	 */
	 ...
	 *
	 * @param transferRate The transfer rate on each of the switch ports.
	 */
	 ...
	 *
	 * @param wanPorts The wan ports meant to connect to different subnets.
	 */
	...
	/**
	 * Function for replacing a spesific given connection interface with a 
	 * given new interface.
	 * 
	 * @param NewItem The interface to replace the previous one.
	 * @param OldItem The interface to be replaced.
	 */
	public void changeConncetionInterfacesItem(String NewItem, String OldItem)
	{
		conncetionInterfaces = ArrayManagment.changeArrayItem(NewItem
				,OldItem, conncetionInterfaces);
	}
	 ...
	 * 
	 * @param ToBeRemoved Connection interfaces to be removed.
	 */
	public void removeConncetionInterfacesItem(String[] ToBeRemoved) 
	throws StringNotFoundInArrayException
	{
		conncetionInterfaces = ArrayManagment.removeItems(
				ToBeRemoved, conncetionInterfaces);
	}
	 ...
	 * 
	 * @param NewItems An array of new conncetion interfaces.
	 */
	public void addConncetionInterfacesItem(String[] NewItems) throws Exception
	{
		conncetionInterfaces = ArrayManagment.addItems(
				NewItems, conncetionInterfaces);
	...
	/**
	 * Function for replacing a spesific given link protocol with a 
	 * given new protocol.
	 * 
	 * @param NewItem The protocol to replace the previous one.
	 * @param OldItem The protocol to be replaced.
	 */
	 ...
	 * 
	 * @param ToBeRemoved Link protocol to be removed.
	 */
	public void removeLinkProtocolItem(String[] ToBeRemoved) 
	throws StringNotFoundInArrayException
	{
		supportedLinkProtocols = ArrayManagment.removeItems(
				ToBeRemoved, supportedLinkProtocols);
	}
	 ...
	 * 
	 * @param NewItems An array of new link protocols.
	 */
	public void addLinkProtocolItem(String[] NewItems) throws Exception
	{
		supportedLinkProtocols = ArrayManagment.addItems(
				NewItems, supportedLinkProtocols);
	...
	{
		supportedRemoteManageProtocols = ArrayManagment.changeArrayItem(NewItem
				,OldItem, supportedRemoteManageProtocols);
	}
	
	
	/**
	 * Function to remove remote management protocols from the array of 
	 ...
	 * 
	 * @param NewItems An array of new remote management protocols.
	 */
	public void addRemoteManagementProtocolsItem(String[] NewItems) throws Exception
	{
		supportedRemoteManageProtocols = ArrayManagment.addItems(
				NewItems, supportedRemoteManageProtocols);
	...
	/**
	 * Function for replacing a spesific given transport protocol with a 
	 * given new protocol.
	 * 
	 * @param NewItem The protocol to replace the previous one.
	 * @param OldItem The protocol to be replaced.
	...
	/**
	 * Function to remove transport protocols from the array of 
	 * transport protocols.
	 * 
	 * @param ToBeRemoved Link protocol to be removed.
	 */
	 ...
	 * 
	 * @param NewItems An array of new transport protocols.
	 */
