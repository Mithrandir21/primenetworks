...
/**
 * A representation of a internal connection between two devices. 
 * This can be between a hdd and a motherboard, a CPU and a motherboard, hot-swap 
 * HDD and a server and so on.
 * So any connection within a computer is representanted by an internalConnection object. 
 *
