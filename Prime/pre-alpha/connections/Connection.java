...
/**
 * A representation of any connection between any to devices in the entier system.
 * This can be a connection between a computer and a printer, a computer and a router,
 * a router and a server, a router and another router and so on.
 * 
 *
...
public abstract class Connection extends Object implements Serializable
{
	 ...
	 * @param From The object the connection eminated from.
	 * @param To The object which is to be connected to. 
	 * @param connection The tyoe of connection between the objects.
	 */
	...
	/**
	 * Get the second object in the connection. Normally the object which is to be
	 * connected to.
	 *
	 */
	 ...
	 * Description NEEDED!
	 *
	 * @param connectionRate the connectionRate to set
	 */
