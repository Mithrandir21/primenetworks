...
/**
 * A representation of a connection between networking devices. 
 * This can be between a computer and a router, a computer and and another computer,
 * a router and another router and so on.
 * In computers the connection is normally maid with the NIC.
 *
