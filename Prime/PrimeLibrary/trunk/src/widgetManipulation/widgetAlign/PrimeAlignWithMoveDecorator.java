...
/**
 * This class only provides an overriding of the createLineWidget(Scene scene)
 * method in the {@link AlignWithMoveDecorator} class that returns a
 * {@link ConnectionWidget} that will represent an aligning line on a specific
 * {@link Scene}.
 * 
