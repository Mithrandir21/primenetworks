...
/**
 * This class represents a desktop machine. This can be any machine that has the necessary equipment to run by its self
 * without the need for add from any other objects. <br>
 * An instance of this object will contain an array of pointers to the different components of the desktop system. This
 * will represent the objects that make up the actual desktop, like a mouse, a monitor, a HDD, a motherboard and so on.<br>
 * Each instance of this object will also contain an array of pointers to devices connected to the system. These will
 * reperesente the network around the system, like switches, servers, firewalls, printer and so on. <br>
 * <br>
 * TODO - Make desktop rating system.<br>
 * A system that rates a desktop machine depending on the type of components it has.(Components must then also have a
