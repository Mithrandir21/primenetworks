 ...
 * components of the laptop system. This
 * will represent the objects that make up the actual laptop, like a mouse, a
 ...
 * represente the network around the system, like switches, servers, firewalls,
 * printer and so on. <br>
 * <br>
 * FIXME - Make laptop rating system.<br>
 * A system that rates a laptop machine depending on the type of components it
 * has.(Components must then also have a way
...
public class Laptop extends Clients implements Serializable
{
	 ...
	 * laptop rating to "0"(since the rating
