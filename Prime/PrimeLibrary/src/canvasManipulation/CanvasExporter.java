...
public class CanvasExporter
{
	...
	/**
	 * Finds and returns the {@link WidgetObject} that is located at the most eastern edge on a {@link WorkareaCanvas}.
	 * 
	 * @param canvas
	 * @return
	 */
	...
	/**
	 * Finds and returns the {@link WidgetObject} that is located at the most western edge on a {@link WorkareaCanvas}.
	 * 
	 * @param canvas
	 * @return
	 */
	...
	public static Point getCanvasStart(WorkareaCanvas canvas)
	{
		...
		Point first = new Point(left - 10, top - 10);
	...
	public static Point getCanvasEnd(WorkareaCanvas canvas)
	{
		...
		Point last = new Point(right + 10, bottom + 10);
