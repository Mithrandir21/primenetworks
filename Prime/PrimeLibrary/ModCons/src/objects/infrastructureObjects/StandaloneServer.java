...
public class StandaloneServer extends Infrastructure implements Serializable
{
	 ...
	 */
	public StandaloneServer(String Name, String Desc, String[] SupConInt,
	...
	{
		Object[] componentsFound = ArrayManagment.getSpesificComponents(
				connectedDeviceClass, this.components, this.componentCounter);
