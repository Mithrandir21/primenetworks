 ...
 * mouse interaction for a {@link MoveRoomAction}.
 */
public class MoveRoomAction extends WidgetAction.LockedAdapter
{
	...
	public State mousePressed(Widget widget, WidgetMouseEvent event)
	{
				...
				&& Settings.roomsManipulation )
		{
			...
			this.originalSceneLocation = this.provider
	...
	private boolean move(Widget widget, Point newLocation)
	{
		...
		Point location = new Point(originalSceneLocation.x + newLocation.x
				...
				- dragSceneLocation.y);
		this.provider.setNewLocation(widget, this.strategy.locationSuggested(
				widget, this.originalSceneLocation, location));
		return true;
	}
