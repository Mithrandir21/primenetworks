...
/**
 * This class represents an abstract system action. This class should be
 * extended when new actions are created.
 * The class allows for the action to be undone, but it is not required.
 * 
