...
public class NetworkRulesFrame extends JDialog implements ActionListener
{
	...
	/**
	 * The {@link WorkareaCanvas} that contains the rules.
	 */
	...
	private JXTaskPaneContainer createRulesTabes()
	{
		...
		tpc.add(new HardwareRulesPanel(canvas.getRules()));
		tpc.add(new SoftwareRulesPanel(canvas.getRules()));
		tpc.add(new InfrastructureRulesPanel(canvas.getRules()));
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			// If any changes has been made to the rules
			if ( changed )
			{
