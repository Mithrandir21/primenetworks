...
import graphics.GUI.standardObjectEdit.ObjectSoftwareViewTabbed;
 ...
 * 
 */
public class StandardObjectSoftwareEditor extends JFrame implements
		ActionListener
{
	private Object givenObject = null;

	private ObjectSoftwareViewTabbed view;
	 ...
	 * @param obj
	 */
	public StandardObjectSoftwareEditor(Object obj)
	{
		...
		view = new ObjectSoftwareViewTabbed(obj);
		panel.add(view);
