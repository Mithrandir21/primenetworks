...
public class SoftwareObjectView extends JPanel implements ActionListener
{
	...
	private StandardObjectSoftwareEditor SWeditor = null;
	 ...
	 */
	public StandardObjectSoftwareEditor createNewSoftwareEditor(Object obj)
	{
		return SWeditor = new StandardObjectSoftwareEditor(obj);
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		if ( e.getActionCommand().equals("edit") )
		{
			...
			{
				SWeditor = new StandardObjectSoftwareEditor(givenObject);
			}
		}
	...
	/**
	 * Returns the {@link StandardObjectSoftwareEditor}.
	 */
	public StandardObjectSoftwareEditor getSoftwareView()
	{
		return SWeditor;
	}
	...
	/**
	 * This functions disposes the {@link StandardObjectSoftwareEditor} editor
	 * and sets it to NULL.
	 */
	public void disposeSoftwareView()
	{
		if ( SWeditor != null )
		{
			SWeditor.dispose();
