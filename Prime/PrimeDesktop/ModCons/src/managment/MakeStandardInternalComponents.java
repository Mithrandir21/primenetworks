...
public class MakeStandardInternalComponents
{
	...
	{
		return new Motherboard(PrimeMain.texts.getString("standardMBName"),
	...
	public ExternalNetworksCard getSt_ExtNIC()
	{
		...
		return new ExternalNetworksCard(
				PrimeMain.texts.getString("standardExtNICName"),
				PrimeMain.texts.getString("standardExtNICDescription"),
				PrimeMain.texts.getString("standardExtNICProducer"), mac,
	...
	public InternalNetworksCard getSt_IntNIC()
	{
		...
		return new InternalNetworksCard(
				PrimeMain.texts.getString("standardIntNICName"),
				PrimeMain.texts.getString("standardIntNICDescription"),
				PrimeMain.texts.getString("standardIntNICProducer"),
				ConnectionUtils.PCI, mac, ConnectionUtils.RJ45);
	}
