 ...
 * 
 */
public class ActionResetSystemSettings extends AbstractSystemAction
{
	/**
	 ...
	 */
	public ActionResetSystemSettings(String text, ImageIcon icon)
	{
		super(text, icon);
	}
	 ...
	 *            The name of the action.
	 */
	public ActionResetSystemSettings(String text)
	{
		super(text);
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		String question = PrimeMain.texts
				.getString("settingsAdvancedResetSettingsQuestion")
